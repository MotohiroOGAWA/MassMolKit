...
class TestCleavagePattern(unittest.TestCase):
    ...
    def test_cleavage_pattern_application(self):
        ...
        result0 = self.cleavage_pattern_lib.patterns[0].fragment_at_atom_idx(self.acetamide, (0, 1))
        result1 = self.cleavage_pattern_lib.patterns[0].fragment_at_atom_idx(self.acetamide, (1, 0))
        result2 = self.cleavage_pattern_lib.patterns[0].fragment_at_atom_idx(self.acetamide, (2, 3))
        result3 = self.cleavage_pattern_lib.patterns[0].fragment_at_atom_idx(self.acetamide, (3, 2))
        result4 = self.cleavage_pattern_lib.patterns[0].fragment_at_atom_idx(self.acetamide, (4, 5))
        pass
